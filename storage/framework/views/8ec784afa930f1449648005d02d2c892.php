                ...
                <div class="card mb-2">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">3. Masukkan nominal transfer:
                            <b><?php echo e($tagihan->total_tagihan); ?></b>
                        </li>
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                    <div class="image-card-mycars">
                        <img class="border" style="width: 200px; height: 150px; object-fit: cover; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#imageModal" src="<?php echo e(asset('storage/uploads/' . $upload->file_name . '.' . $upload->file_type)); ?>" alt="<?php echo e($upload->file_name . '.' . $upload->file_type); ?>">
                        <?php if($tagihan->status === 'ON PROCESS'): ?>
                        <button type="button" class="delete-button-mycars" style="position:absolute;top:0;right:0;background-color:rgba(255,0,0,0.7);color:#fff;border:none;border-radius:50%;cursor:pointer;width:25px;height:25px;display:flex;align-items:center;justify-content:center;" onclick="deleteImage('<?php echo e($upload->id); ?>')">X</button>
                        <?php endif; ?>
                    </div>
                </div>
                <?php else: ?>
                <form method="POST" action="<?php echo e(route('upload.bukti')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="text" name="tagihanId" id="tagihanId" value="<?php echo e($tagihan->id); ?>" hidden>
...
</div><?php /**PATH C:\xampp\htdocs\koperasi-tebu-manis-agung\resources\views/components/pembayaran.blade.php ENDPATH**/ ?>