                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control number-format" name="noTelp" id="noTelp"
                                    value="<?php echo e($user->no_telp); ?>" disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="tempatLahir" id="tempatLahir" required>
                                    ...
                                    <?php $__currentLoopData = json_decode(file_get_contents('https://www.emsifa.com/api-wilayah-indonesia/api/provinces.json')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tempat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tempat->name); ?>"
                                            <?php if($tempat->name == $user->tempat_lahir): ?> selected <?php endif; ?>>
                                            <?php echo e($tempat->name); ?></option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="statusKeanggotaan" id="statusKeanggotaan"
                                    value="<?php echo e($user->status_keanggotaan); ?>" disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="penghasilanPerbulan"
                                    id="penghasilanPerbulan" value="<?php echo e($user->penghasilan_perbulan); ?>" disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="statusPinjaman" id="statusPinjaman"
                                    value="<?php echo e($user->status_pinjaman); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($user->email); ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="umur" id="umur"
                                    value="<?php echo e($user->umur); ?>" disabled>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="luasLahan" id="luasLahan"
                                    value="<?php echo e($user->luas_lahan); ?>" disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="penghasilanPanen" id="penghasilanPanen"
                                    value="<?php echo e($user->penghasilan_panen); ?>" disabled>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="pinjamanSebelumnya"
                                    id="pinjamanSebelumnya" value="<?php echo e($user->pinjaman_sebelumnya); ?>" disabled>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card shadow col-xl-12 col-md-12 mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('change.password', ['userId' => $user->id])); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koperasi-tebu-manis-agung\resources\views/profile/index.blade.php ENDPATH**/ ?>