    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion hide-print" id="accordionSidebar">
            ...
            <?php if(Auth::user()->role === 'ADMIN'): ?>
                <li class="nav-item <?php echo e(request()->routeIs('admin.user.index') ? 'active' : ''); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item <?php echo e(request()->routeIs('pinjaman.index') ? 'active' : ''); ?>">
                <a class="nav-link d-flex justify-content-between align-items-center"
                    href="<?php echo e(route('pinjaman.index')); ?>">
                    <div>
            ...
            <li class="nav-item <?php echo e(request()->routeIs('tagihan.index') ? 'active' : ''); ?>">
                <a class="nav-link d-flex justify-content-between align-items-center"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Koperasi Tebu Manis Agung <?php echo e(date('Y')); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        function updateNotificationBadges() {
            fetch("<?php echo e(route('notification')); ?>")
...
<?php /**PATH C:\xampp\htdocs\koperasi-tebu-manis-agung\resources\views/components/layout.blade.php ENDPATH**/ ?>