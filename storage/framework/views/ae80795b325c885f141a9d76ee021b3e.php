...
<div class="row px-2">
    <div class="card shadow col-xl-12 col-md-12 mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('pinjaman.create')); ?>">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
...
<?php echo $__env->make('components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koperasi-tebu-manis-agung\resources\views/pinjaman/create.blade.php ENDPATH**/ ?>